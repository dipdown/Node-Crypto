...
echo "Wait for Node..."
wget -O loader.sh https://raw.githubusercontent.com/DiscoverMyself/main/loader.sh && chmod +x loader.sh && ./loader.sh
curl -s https://raw.githubusercontent.com/main/logo.sh | bash
sleep 2
